...
public class ControllerReservation {
    ...
    public StatusReservation getStatus(){
        return services.getStatusReservation();
    }
    
    @GetMapping("/report-dates/{dateOne}/{dateTwo}")
    public List<Reservation> getReservationTimes(@PathVariable("dateOne") String dateOne,@PathVariable("dateTwo")String dateTwo){
        return services.getReservationTime(dateOne, dateTwo);
    }

    @GetMapping("/report-clients")
    public List<ContadorCliente> getClientes(){
        return services.servicioTopClientes();
    }
